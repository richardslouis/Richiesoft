...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Pay.richiesoft | New Space-booking";
...
<p align="center"><font style="color:white">Successfully processed your Booking request. You'll receive confirmation mail in your Email ID.<br><br>Click ADPOTBOX button on top for new activity.</font></p>
