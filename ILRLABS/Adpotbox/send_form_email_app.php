...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Pay.richiesoft | New Cheque deposit";
...
<p align="center"><font style="color:white">Successfully processed your cheque details. You'll receive confirmation mail in your Email ID.<br><br>Click ADPOTBOX button on top for new activity.</font></p>
